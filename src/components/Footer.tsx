      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            ...
            className="fixed bottom-24 right-6 w-12 h-12 bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-600 hover:from-emerald-600 hover:via-teal-600 hover:to-cyan-700 text-white rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 z-30 flex items-center justify-center group border-2 border-white/20 backdrop-blur-sm"
