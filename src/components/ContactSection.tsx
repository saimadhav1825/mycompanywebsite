...
export function ContactSection(): React.JSX.Element {
  return (
    <section id="contact" className="relative container mx-auto px-4 py-24 bg-gradient-to-br from-gray-50 to-emerald-50 overflow-hidden">
      ...
      <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto relative z-10">
        ...
        >
          <div className="relative bg-white/20 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-white/30 overflow-hidden">
            ...
            {/* Floating Particles */}
            <div className="absolute top-6 right-6 w-2 h-2 bg-emerald-400/40 rounded-full animate-ping"></div>
            <div className="absolute bottom-6 left-6 w-1.5 h-1.5 bg-teal-400/40 rounded-full animate-ping delay-1000"></div>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg relative overflow-hidden">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg relative overflow-hidden">
                    <div className="absolute inset-0 animate-shimmer"></div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-rose-500 to-pink-500 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg relative overflow-hidden">
                    <div className="absolute inset-0 animate-shimmer"></div>
              ...
              <div className="pt-6 border-t border-white/20">
                ...
                <div className="flex gap-4">
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer"
                    className="w-10 h-10 bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-xl flex items-center justify-center text-white hover:shadow-lg transform hover:scale-110 transition-all duration-300 relative overflow-hidden group"
                  >
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer"
                    className="w-10 h-10 bg-gradient-to-r from-slate-600 to-slate-700 rounded-xl flex items-center justify-center text-white hover:shadow-lg transform hover:scale-110 transition-all duration-300 relative overflow-hidden group"
                  >
                    <div className="absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer"
                    className="w-10 h-10 bg-gradient-to-r from-cyan-400 to-cyan-500 rounded-xl flex items-center justify-center text-white hover:shadow-lg transform hover:scale-110 transition-all duration-300 relative overflow-hidden group"
                  >
                    <div className="absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="text-2xl font-semibold mb-6 text-gray-900">Start Your Project</h3>
            <ContactForm />
          </div>
        </motion.div>
      </div>
